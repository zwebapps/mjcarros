...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspDev = [
      ...
      "img-src 'self' data: https://*.stripe.com https://images.unsplash.com https://www.paypalobjects.com https://*.paypal.com https://*.s3.amazonaws.com https://*.s3.*.amazonaws.com",
